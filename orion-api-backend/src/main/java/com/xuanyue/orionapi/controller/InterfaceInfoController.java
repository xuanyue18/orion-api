...
import com.xuanyue.orionapi.config.GatewayConfig;
import com.xuanyue.orionapi.exception.BusinessException;
import com.xuanyue.orionapi.exception.ThrowUtils;
import com.xuanyue.orionapi.service.InterfaceInfoService;
import com.xuanyue.orionapi.service.UserService;
import com.xuanyue.orionapicommon.common.*;
import com.xuanyue.orionapicommon.constant.CommonConstant;
import com.xuanyue.orionapicommon.constant.UserConstant;
import com.xuanyue.orionapicommon.model.dto.interfaceinfo.InterfaceInfoAddRequest;
import com.xuanyue.orionapicommon.model.dto.interfaceinfo.InterfaceInfoInvokeRequest;
...
import com.xuanyue.orionapicommon.model.enums.InterfaceInfoStatusEnum;
...
public class InterfaceInfoController {
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        // 获取SDK客户端
        OrionApiClient orionApiClient = interfaceInfoService.getOrionApiClient(request);
        // 设置网关地址
        orionApiClient.setGatewayHost(gatewayConfig.getHost());
        try {
            // 执行方法
            String invokeResult = orionApiClient.invokeInterface(requestParams, url, method);
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        try {
            // 执行方法
            invokeResult = orionApiClient.invokeInterface(requestParams, url, method);
            if (StringUtils.isBlank(invokeResult)) {
                throw new BusinessException(ErrorCode.SYSTEM_ERROR, "接口数据为空");
            }
        } catch (Exception e) {
